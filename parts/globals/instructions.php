<div id="instructions" class="gray-lighter-back"><a href="#" id="instructions_tab" class="gray-lighter-back gray-dark-text"><i class="fa fa-info-circle"></i></a>
	...
	<p>Generally there are two types of test that will be run.  A manual test where you will click through and watch the output in a google analytics debugger.  The other type of test will be an automated clicking of links where it will move from one page to another and without you doing anything.  A set of links will have the <code>click</code> event triggered to simulate a user.  It'll clear out cookies, reset itself and then start again on a new block of the test until all blocks have been completed.</p>
	<h5>Help/issues</h5>
	<p>You may ask questions or raise issues about the gauntlet here at the github repo of<a href="https://github.com/washingtonstateuniversity/WSU-GA-gauntlet">WSU-GA-gauntlet</a>.  You may also contact the current test maintainer, <a href="mailto:jeremy.bass@wsu.edu?subject=WSU-GA-gauntlet%20question">Jeremy Bass</a> with any questions.  Thank you for your interest and participation.</p>
</div>